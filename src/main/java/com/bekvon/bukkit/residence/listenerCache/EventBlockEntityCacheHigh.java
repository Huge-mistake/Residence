 ...
 */
public class EventBlockEntityCacheHigh {

    private static final Cache<EventBlockEntityKey, Boolean> EVENT_BLOCK_ENTITY_CACHE = Caffeine.newBuilder()
            .expireAfterWrite(3, TimeUnit.SECONDS)
            .maximumSize(10_000)
            .build();

    private EventBlockEntityCacheHigh() {
    }

    public static boolean isDenied(EventBlockEntityKey key) {
        return EVENT_BLOCK_ENTITY_CACHE.getIfPresent(key) == Boolean.TRUE;
    }
