...
public enum lm {
    ...
    Invalid_NameLegth("&cName length too long, max %1 characters"),
...
//    Area_ToSmallTotal("&cSelected area smaller than allowed minimal (&6%1&c)"),
    ...
    Residence_NotOwned("&cPlayer &6%1 &cdoes not own any residences."),
    Residence_OwnerChangeAll("&eTransferred &6%1 &eresidence(s) from &6%2 &eto &6%3"),
    Residence_OwnerChangeAllSkipped("&cSkipped &6%1 &cresidence(s) due to active raids."),
