...
public enum Flags {
    ...
    animalgriefing(CMIMaterial.WHEAT, FlagMode.Residence, "Allow or deny animal griefing (does not override block/entity-specific flags)", true),
    ...
    cartography(CMIMaterial.CARTOGRAPHY_TABLE, FlagMode.Both, "Allows or denys players to use cartography tables", true),
    ...
    fletching(CMIMaterial.FLETCHING_TABLE, FlagMode.Both, "Allows or denys players to use fletching tables", true),
    ...
    grindstone(CMIMaterial.GRINDSTONE, FlagMode.Both, "Allows or denys players to use grindstones", true),
...
//    overridepvp(CMIMaterial.IRON_SWORD, FlagMode.Residence, "Overrides any plugin pvp protection", false),
    ...
    push(CMIMaterial.COBWEB, FlagMode.Both, "Allow or deny players pushing entities(not for player-player)", true),
    ...
    smithing(CMIMaterial.SMITHING_TABLE, FlagMode.Both, "Allows or denys players to use smithing tables", true),
    ...
    stonecutter(CMIMaterial.STONECUTTER, FlagMode.Both, "Allows or denys players to use stonecutters", true),
